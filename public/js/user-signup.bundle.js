...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/LoginForm.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/auth/LoginForm.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _validators_login__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../validators/login */ \"./resources/js/validators/login.js\");\n/* harmony import */ var _validators_adminLogin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../validators/adminLogin */ \"./resources/js/validators/adminLogin.js\");\n/* harmony import */ var _validators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../validators */ \"./resources/js/validators/index.js\");\n/* harmony import */ var _components_InputBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/InputBox */ \"./resources/js/components/InputBox.vue\");\n/* harmony import */ var _components_CsrfInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/CsrfInput */ \"./resources/js/components/CsrfInput.vue\");\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: ['oldInputs', 'serverError', 'forAdmin', 'adminPath'],\n  components: {\n    InputBox: _components_InputBox__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n    CsrfInput: _components_CsrfInput__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\n  },\n  data: function data() {\n    return {\n      values: {\n        email: '',\n        password: ''\n      },\n      errors: {\n        email: '',\n        password: ''\n      }\n    };\n  },\n  mounted: function mounted() {\n    try {\n      if (this.oldInputs) {\n        var oldInputs = JSON.parse(this.oldInputs);\n\n        for (var key in oldInputs) {\n          this.values[key] = oldInputs[key];\n        }\n      }\n\n      if (this.serverError) {\n        var serverError = JSON.parse(this.serverError);\n\n        for (var _key in serverError) {\n          this.errors[_key] = serverError[_key];\n        }\n      }\n\n      if (this.forAdmin) {\n        this.values.secret = '';\n        this.errors.secret = '';\n      }\n    } catch (error) {\n      console.log(error);\n    }\n  },\n  methods: {\n    getSchema: function getSchema() {\n      if (this.forAdmin) return _validators_adminLogin__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\n      return _validators_login__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    },\n    checkForm: function checkForm() {\n      this.errors = Object(_validators__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(this.getSchema(), this.values) || {};\n      return Object.keys(this.errors).length == 0;\n    },\n    submit: function submit() {\n      if (this.checkForm()) this.$refs.form.submit();\n    }\n  }\n});\n\n//# sourceURL=webpack:///./resources/js/auth/LoginForm.vue?./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/LoginForm.vue?vue&type=template&id=2892a704&":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/auth/LoginForm.vue?vue&type=template&id=2892a704& ***!
  \******************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return render; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"staticRenderFns\", function() { return staticRenderFns; });\nvar render = function() {\n  var _vm = this\n  var _h = _vm.$createElement\n  var _c = _vm._self._c || _h\n  return _c(\n    \"form\",\n    {\n      ref: \"form\",\n      staticClass: \"mb-l\",\n      attrs: {\n        action: _vm.forAdmin ? _vm.adminPath + \"/login\" : \"/login\",\n        method: \"post\"\n      }\n    },\n    [\n      _c(\"input-box\", {\n        attrs: {\n          type: \"email\",\n          label: \"Email\",\n          name: \"email\",\n          error: _vm.errors.email\n        },\n        model: {\n          value: _vm.values.email,\n          callback: function($$v) {\n            _vm.$set(_vm.values, \"email\", $$v)\n          },\n          expression: \"values.email\"\n        }\n      }),\n      _vm._v(\" \"),\n      _c(\"input-box\", {\n        attrs: {\n          type: \"password\",\n          label: \"Password\",\n          name: \"password\",\n          error: _vm.errors.password\n        },\n        model: {\n          value: _vm.values.password,\n          callback: function($$v) {\n            _vm.$set(_vm.values, \"password\", $$v)\n          },\n          expression: \"values.password\"\n        }\n      }),\n      _vm._v(\" \"),\n      _vm.forAdmin\n        ? _c(\"input-box\", {\n            attrs: {\n              type: \"password\",\n              label: \"Secret\",\n              name: \"secret\",\n              error: _vm.errors.secret\n            },\n            model: {\n              value: _vm.values.secret,\n              callback: function($$v) {\n                _vm.$set(_vm.values, \"secret\", $$v)\n              },\n              expression: \"values.secret\"\n            }\n          })\n        : _vm._e(),\n      _vm._v(\" \"),\n      _c(\"csrf-input\"),\n      _vm._v(\" \"),\n      _vm.errors && _vm.errors.default\n        ? _c(\"small\", { staticClass: \"text-danger\" }, [\n            _vm._v(_vm._s(_vm.errors.default))\n          ])\n        : _vm._e(),\n      _vm._v(\" \"),\n      _c(\"div\", { staticClass: \"flex justify-content-center mt-xl\" }, [\n        _c(\n          \"button\",\n          {\n            staticClass: \"btn btn-primary btn-lg\",\n            attrs: { type: \"submit\" },\n            on: {\n              click: function($event) {\n                $event.preventDefault()\n                return _vm.submit($event)\n              }\n            }\n          },\n          [_vm._v(\"\\n      Login\\n    \")]\n        )\n      ])\n    ],\n    1\n  )\n}\nvar staticRenderFns = []\nrender._withStripped = true\n\n\n\n//# sourceURL=webpack:///./resources/js/auth/LoginForm.vue?./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options");
...
/***/ "./resources/js/auth/LoginForm.vue":
/*!*****************************************!*\
  !*** ./resources/js/auth/LoginForm.vue ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LoginForm.vue?vue&type=template&id=2892a704& */ \"./resources/js/auth/LoginForm.vue?vue&type=template&id=2892a704&\");\n/* harmony import */ var _LoginForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LoginForm.vue?vue&type=script&lang=js& */ \"./resources/js/auth/LoginForm.vue?vue&type=script&lang=js&\");\n/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ \"./node_modules/vue-loader/lib/runtime/componentNormalizer.js\");\n\n\n\n\n\n/* normalize component */\n\nvar component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\n  _LoginForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__[\"render\"],\n  _LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"],\n  false,\n  null,\n  null,\n  null\n  \n)\n\n/* hot reload */\nif (false) { var api; }\ncomponent.options.__file = \"resources/js/auth/LoginForm.vue\"\n/* harmony default export */ __webpack_exports__[\"default\"] = (component.exports);\n\n//# sourceURL=webpack:///./resources/js/auth/LoginForm.vue?");

/***/ }),

/***/ "./resources/js/auth/LoginForm.vue?vue&type=script&lang=js&":
/*!******************************************************************!*\
  !*** ./resources/js/auth/LoginForm.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./LoginForm.vue?vue&type=template&id=2892a704& */ \"./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/LoginForm.vue?vue&type=template&id=2892a704&\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__[\"render\"]; });\n\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"staticRenderFns\", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_LoginForm_vue_vue_type_template_id_2892a704___WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"]; });\n\n\n\n//# sourceURL=webpack:///./resources/js/auth/LoginForm.vue?");
...
/***/ "./resources/js/validators/adminLogin.js":
/*!***********************************************!*\
  !*** ./resources/js/validators/adminLogin.js ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./resources/js/validators/login.js":
/*!******************************************!*\
  !*** ./resources/js/validators/login.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _hapi_joi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @hapi/joi */ \"./node_modules/@hapi/joi/dist/joi-browser.min.js\");\n/* harmony import */ var _hapi_joi__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_hapi_joi__WEBPACK_IMPORTED_MODULE_0__);\n\nvar schema = _hapi_joi__WEBPACK_IMPORTED_MODULE_0___default.a.object({\n  email: _hapi_joi__WEBPACK_IMPORTED_MODULE_0___default.a.string().required().email({\n    tlds: false\n  }).messages({\n    'string.empty': \"Email is required.\",\n    'string.required': \"Email is required.\",\n    'string.email': \"Email is not valid.\"\n  }),\n  password: _hapi_joi__WEBPACK_IMPORTED_MODULE_0___default.a.string().required().min(8).messages({\n    'string.empty': \"Password is required.\",\n    'string.required': \"Password is required.\",\n    'string.min': \"Password should be minimim of {#limit} characters.\"\n  })\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (schema);\n\n//# sourceURL=webpack:///./resources/js/validators/login.js?");
